...
public class menurestab extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menurestab);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent ins = new Intent(menurestab.this,results.class);
...
//                            (menurestab.this, android.R.layout.simple_spinner_dropdown_item, names));
//
//
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            for (int i = 0 ; i<jsonArray.length();i++){
                                ...
                                Toast.makeText(menurestab.this, "Table Number :"+myString, Toast.LENGTH_SHORT).show();
                                final menuadapter menuadapter = new menuadapter(menurestab.this,menugets,myString);
                            ...
                            e.printStackTrace();
                            Toast.makeText(menurestab.this, "Something Error "+e.toString(), Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(menurestab.this, "Something Error "+error.toString(), Toast.LENGTH_SHORT).show();
                    }
                })
        {
            @Override
...
//                                Toast.makeText(menurestab.this, "Table Menu Cancel", Toast.LENGTH_SHORT).show();
//                            }
//                        } catch (JSONException e) {
//                            e.printStackTrace();
//                            Toast.makeText(menurestab.this, "Ero ka!"+ e.toString(), Toast.LENGTH_SHORT).show();
//                        }
//                    }
//                }, new Response.ErrorListener() {
//            @Override
//            public void onErrorResponse(VolleyError error) {
//                Toast.makeText(menurestab.this, "haha"+error.toString(), Toast.LENGTH_SHORT).show();
//            }
//        }){
//            @Override
...
//
//                    if (successs.equals("1")){
//                        Toast.makeText(menurestab.this, "Table change Cancel", Toast.LENGTH_SHORT).show();
//                        startActivity(new Intent(menurestab.this,reserlist.class));
//                        finish();
//                    }
//
//                } catch (JSONException e) {
...
//            public void onErrorResponse(VolleyError error) {
//                error.printStackTrace();
//                Toast.makeText(menurestab.this, "Erokon taka!"+ error.toString(), Toast.LENGTH_SHORT).show();
//
//            }
//        }){
//            @Override
